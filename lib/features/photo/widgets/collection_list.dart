...
class CollectionList extends StatelessWidget {
  ...
  final void Function(PhotoCollection collection) onDelete;
  final void Function(String bid, bool isAlbum) onAlbumToggle;
  ...
  int _resolveChildCount() {
    if (isLoading || errorMessage != null || collections.isEmpty) {
      return 1;
    }
...
void _showCollectionActions(
  ...
  required void Function(String bid, bool isAlbum) onAlbumToggle,
  required void Function(PhotoCollection collection) onDelete,
}) {
        ...
        if (collection.isAlbum)
          ActionItem(
            ...
            onTap: () {
              ...
              onAlbumToggle(collection.bid, false);
            },
          )
        else
          ActionItem(
            ...
            onTap: () {
              Navigator.of(context).pop();
              onAlbumToggle(collection.bid, true);
            },
          ),
        ActionItem(
          label: '删除集合',
